  ...
  const handleDelete = async (agentIdToDelete) => { // Renamed parameter for clarity
    ...
    if (window.confirm("Are you sure you want to delete this agent?")) {
        try {
          ...
          await axios.delete(
            `https://web-scrap-scrapy-production.up.railway.app/agents/${agentIdToDelete}`, // Use the agentId (unique code) for DELETE request
            {
              headers: {
                Authorization: getAuthHeader(),
              },
  ...
  const handleUpdateAgent = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://web-scrap-scrapy-production.up.railway.app/agents/${selectedAgent.agent_id}`, // <--- Use selectedAgent.agent_id for PUT request
        {
